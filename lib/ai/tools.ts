...
export const CALU_TOOLS: Anthropic.Tool[] = [
  {
    ...
    description:
      "Get total sales and order count for ONE specific branch over a date range. Only call this for a branch the person is authorized to see - unauthorized branches are rejected by the system, not by you, so it's fine to try and let the system enforce it.",
    input_schema: {
      type: "object",
      properties: {
        branch: {
